...
class AppColors {
  static final Color azul = Color(0xFF2F80ED);
  ...
  static final Color chartPrimary = purple;
  ...
  //Yellow
  static final Color lightYellow = Color(0xFFE5D5C5);
  static final Color yellow = Color(0xFFF5EFE9);
  static final Color darkYellow = Color(0xFFE8891C);

  // Purple
  static final Color purple = Color(0xFF9B51E0);
}
